                ...
                <tr class="small">
                    ...
                    <td>
                        ...
                        @if ($document->is_active )
                            <a data-toggle="tooltip" title="vigente">
                                <i class="far fa-check-circle float-right" style="color: green"></i>
                            </a>
                        @else
                            <a data-toggle="tooltip" title="revogado">
                                <i class="far fa-times-circle float-right" style="color: red;"></i>
                            </a>
                        @endif
                    ...
                    <td class="text-center">
                        ...
                        <a onclick="if (confirm('Tem certeza que deseja RESTAURAR esse documento?')){
                           ...
                           class="btn-sm border" data-toggle="tooltip" title="restaurar documento">
